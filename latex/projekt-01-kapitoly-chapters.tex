...
Proof-of-history je kryptografický algoritmus, ktorý usporiada dátové záznamy v čase tak ako vznikajú. Takýto algoritmus pomáha jednoznačne a nepopierateľne usporiadať transakcie v distribuovanú sieti ako je blockchain. Dôkaz o usporiadaní je založený na kryptografickej hash funkcii (pozri sekciu~\ref{subsec:hash}), ktorá spĺňa kritérium \textit{collision resistant}. 
...
\begin{figure}[bt]
	\centering
	\includegraphics[width=\textwidth]{obrazky-figures/solana-poh}
	\caption{Nepopierateľné usporiadanie transakcií A, B a C v čase pomocou proof-of-history.}
	\label{img:solana-poh}
\end{figure}

\section{Konsenzus}

Proof-of-stake slúži na:
\begin{itemize}
	\item voľbu proof-of-history generátoru
	\item hlasovanie o validnosti aktuálnej proof-of-history sekvencie
	\item model motivácie - odemňovanie a tresty
\end{itemize}
